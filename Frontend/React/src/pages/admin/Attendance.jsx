...
import { CalendarCheck, CheckCircle2, XCircle, Clock, UserCheck, Search, Plus, Filter, AlertTriangle, Send } from "lucide-react";
...
function Attendance() {
  ...
  const loadMasterData = async () => {
    try {
      const [dRes, cRes, semRes, subRes, fRes, stRes, recRes] = await Promise.all([
        getDepartments(),
        getCourses(),
        getSemesters(),
        getSubjects(),
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-slate-800">
                {isStudent ? "My Attendance Record" : "Attendance Management"}
              </h1>
            </div>
