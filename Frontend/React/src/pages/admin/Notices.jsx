...
import { Bell, Plus, Search, Pin, Calendar, Users, Edit, Trash2 } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-slate-800">Notices & Circulars</h1>
            </div>
            <p className="text-sm text-slate-500 mt-1">Publish university-wide announcements, exam notifications, and campus news</p>
          </div>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
                  <div className="flex items-center gap-4">
                    <span className="flex items-center gap-1">
                      <Calendar size={14} /> Posted: {new Date(notice.created_at).toLocaleDateString()}
                    </span>
                    {notice.expiry_date && (
                      <span className="text-slate-500 font-medium">Expires: {notice.expiry_date}</span>
                    )}
                  </div>
